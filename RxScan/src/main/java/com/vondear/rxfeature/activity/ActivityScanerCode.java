...
import com.vondear.rxfeature.tool.RxAnimationTool;
import com.vondear.rxfeature.tool.RxBarTool;
import com.vondear.rxfeature.tool.RxBeepTool;
import com.vondear.rxfeature.tool.RxPhotoTool;
            ...
            try {
                ...
                if (rawResult != null) {
                    if (mScanerListener == null) {
                        ...
                        mScanerListener.onSuccess("From to Picture", rawResult.getText());
                    }
                } else {
                    if (mScanerListener == null) {
...
//        });
    ...
    public void handleDecode(Result result) {
        ...
        if (mScanerListener == null) {
            ...
            mScanerListener.onSuccess("From to Camera", result1);
        }
    }
    //==============================================================================================解析结果 及 后续处理 end
